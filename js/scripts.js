...
$(function(){
  ...
  if( largura > 1300 ){
    ...
    $("#hidraulica").attr('style', 'margin-top: 2rem; margin-bottom: 2rem; padding: 2rem 0.75rem 2rem 0;');
    $("#eletrica").attr('style', 'margin-top: 2rem; margin-bottom: 2rem; padding: 2rem 0 2rem 0.75rem;');
    $("#pintura_predial").attr('style', 'margin-top: 2rem; margin-bottom: 2rem; padding: 2rem 0.75rem 2rem 0;');
    $("#revestimentos").attr('style', 'margin-top: 2rem; margin-bottom: 2rem; padding: 2rem 0 2rem 0.75rem;');
    $("#impermeabilizacao").attr('style', 'margin-top: 2rem; margin-bottom: 2rem; padding: 2rem 0.75rem 2rem 0;');
    $("#pintura_interna").attr('style', 'margin-top: 2rem; margin-bottom: 2rem; padding: 2rem 0 2rem 0.75rem;');
    $("#telhadista").attr('style', 'margin-top: 2rem; margin-bottom: 2rem; padding: 2rem 0.75rem 2rem 0;');
  }else{
    /** Remover blocos desnecessários */
    ...
    /** Alterar formatação para dar espaçamentos */
    $("#hidraulica").attr('style', 'margin-top: 2rem; margin-bottom: 2rem; padding-top: 2rem;');
    $("#eletrica2").attr('style', 'margin-top: 2rem; margin-bottom: 2rem; padding-top: 2rem;');
    $("#pintura_predial").attr('style', 'margin-top: 2rem; margin-bottom: 2rem; padding-top: 2rem;');
    $("#revestimentos2").attr('style', 'margin-top: 2rem; margin-bottom: 2rem; padding-top: 2rem;');
    $("#impermeabilizacao").attr('style', 'margin-top: 2rem; margin-bottom: 2rem; padding-top: 2rem;');
    $("#pintura_interna2").attr('style', 'margin-top: 2rem; margin-bottom: 2rem; padding-top: 2rem;');
    $("#telhadista").attr('style', 'margin-top: 2rem; margin-bottom: 2rem; padding-top: 2rem;');
